...
class ResNet3dSlowOnly_T_E(ResNet3d_T_E):
...
class ResNet3dSO_T_E(nn.Module):
    def __init__(self, backbone_cfg, cls_head_cfg):
        super().__init__()
        self.backbone = ResNet3dSlowOnly_T_E(**backbone_cfg)
...
class ResNet3d_TSM_ECA(nn.Module):
    def __init__(self, backbone_cfg, cls_head_cfg):
        super().__init__()
        self.model = ResNet3dSO_T_E(backbone_cfg, cls_head_cfg)

...
_base_ = ['./diving48.py']
# -------------服务器---------------------
data_root = '/root/autodl-tmp/data/diving48_hrnet.pkl'
pth_root = '/root/autodl-tmp/best_pth/diving48'
log_root = '/root/tf-logs/diving48'
teacher_root = '/root/autodl-tmp/ckpt/diving48/joint.pth'

test = dict(
    is_test=False,
    ckpt_path='/root/autodl-tmp/best_pth/diving48/epoch=30-vacc=0.5299-vloss=2.529.ckpt',
)
reload = dict(
    is_reload=False,
    ckpt_path='',

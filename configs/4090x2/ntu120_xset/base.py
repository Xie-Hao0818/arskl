...
pth_root = '/root/autodl-tmp/best_pth/ntu120_xset'
log_root = '/root/tf-logs/ntu120'
teacher_root = '/root/autodl-tmp/ckpt/ntu120_xset/joint.pth'

test = dict(
    is_test=False,
    ckpt_path='/root/autodl-tmp/best_pth/ntu120_xsub/epoch=22-vacc=0.8573-vloss=1.437.ckpt',
)
reload = dict(
    is_reload=False,

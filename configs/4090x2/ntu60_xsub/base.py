...
teacher_root = '/root/autodl-tmp/ckpt/ntu60_xsub/joint.pth'

test = dict(
    is_test=False,
    ckpt_path='/root/autodl-tmp/best_pth/ntu60_xsub/epoch=4-vacc=0.9373.ckpt',
)
reload = dict(
    is_reload=True,
    ckpt_path='/root/autodl-tmp/best_pth/ntu60_xsub/epoch=23-vacc=0.8469.ckpt',
)
precision = 32

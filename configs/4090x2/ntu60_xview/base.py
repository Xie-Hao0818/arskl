...
pth_root = '/root/autodl-tmp/best_pth/ntu60_xview'
log_root = '/root/tf-logs/ntu60_xview'
teacher_root = '/root/autodl-tmp/ckpt/ntu60_xview/joint.pth'
test = dict(
    is_test=False,
    ckpt_path='/root/autodl-tmp/best_pth/ntu60_xview/epoch=31-vacc=0.9617-vloss=1.156.ckpt',
)
reload = dict(
    is_reload=False,
    ckpt_path='/root/autodl-tmp/best_pth/ntu60_xview/epoch=1-vacc=0.9595-vloss=1.011.ckpt',
)
precision = '16-mixed'

...
_base_ = ['./ntu120.py']
# -------------服务器---------------------
data_root = '/root/autodl-tmp/arskl/data/ntu120_hrnet.pkl'
pth_root = '/root/autodl-tmp/arskl/best_pth/ntu120'
log_root = '/root/tf-logs/ntu120'
teacher_root = '/root/autodl-tmp/arskl/ckpt/ntu120_xsub/joint.pth'

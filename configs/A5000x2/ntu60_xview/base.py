...
pth_root = '/root/autodl-tmp/arskl/best_pth/ntu60_xview'
log_root = '/root/tf-logs/ntu60_xview'
teacher_root = '/root/autodl-tmp/arskl/ckpt/ntu60_xview/joint.pth'
test = dict(
    is_test=False,
    ckpt_path='/root/autodl-tmp/arskl/best_pth/ntu60_xview/epoch=1-vacc=0.9602-vloss=1.025-tacc=0.96128.ckpt',
)
reload = dict(
    is_reload=False,
    ckpt_path='/root/autodl-tmp/arskl/best_pth/ntu60/epoch=4-vacc=0.9360-vloss=1.081.ckpt',
)
precision = '16-mixed'
